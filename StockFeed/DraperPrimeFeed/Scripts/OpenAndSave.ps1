...
$excel.DisplayAlerts = $false
  ...
  $file = "\\DISKSTATION\Feeds\Stock File Fetcher\StockFeed\DraperPrimeFeed\Scripts\dppreference.xlsx"
  $workbook = $excel.Workbooks.Open($file)
  ...
  $workbook.SaveAs("\\DISKSTATION\Feeds\Stock File Fetcher\StockFeed\DraperPrimeFeed\draperprime.txt", -4158)
  $workbook.Save()
  $workbook.Saved = $True
  $workbook.Close()
